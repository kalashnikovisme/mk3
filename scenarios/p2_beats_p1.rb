# P2 (Sub-Zero) beats P1 across two rounds.
# P1 receives no input and stands still the entire match.
#
# Run via:  dip scenario scenarios/p2_beats_p1.rb

APPROACH_FRAMES       = 15   # frames P2 walks left to close the gap
...
PUSH_FORWARD_FRAMES   = 8    # frames P2 walks left after each combo to stay in range
